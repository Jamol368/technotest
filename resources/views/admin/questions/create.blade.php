                    ...
                    <div class="card-body">
                        <form action="{{ route('questions.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th style="width: 150px"><span class="text-danger">*</span> {{ trans('messages.question_types') }}:</th>
                                    <td>
                                ...
                                <tr>
                                    <th style="width: 150px"><span class="text-danger">*</span> {{ trans('messages.subject') }}:</th>
                                    <td>
                                ...
                                <tr>
                                    <th><span class="text-danger">*</span> {{ trans('messages.question') }}:</th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="difficulty" class="form-control @error('difficulty') is-invalid @enderror" />
                                        @error('difficulty')
                                        <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                @for($i = 1; $i <= 4; $i++)
                                    <tr>
                                        <th>
                                            <strong><span class="text-danger">*</span> {{ chr(64 + $i) }}.</strong>
                                        </th>
                                        <td>
                                            <input type="text" name="options[{{ $i }}]" class="form-control"
                                                   value="{{ old('options['.$i.']') }}" placeholder="{{ trans('messages.option') . ' ' . $i }}" required>
                                        </td>
                                        <td>
                                            <div class="form-check">
                                                <input type="radio" name="correct_option" value="{{ $i }}" class="form-check-input" required>
