    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800">{{ trans('messages.qualifications') }}</h1>
                <p class="my-4"><a class="btn btn-success" href="{{ route('qualifications.create') }}">{{ trans('messages.create') }}</a></p>

                <form class="d-sm-inline-block form-inline mr-auto ml-md-3 my-4 my-md-0 mw-100 navbar-search" action="{{ route('qualifications.index') }}" method="get">
                    @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('qualifications.show', $qualification->id) }}" class="btn btn-sm btn-info">
                                            {{ trans('messages.show') }}
                                        </a>
                                        <a href="{{ route('qualifications.edit', $qualification->id) }}" class="btn btn-sm btn-primary">
                                            {{ trans('messages.edit') }}
                                        </a>
