    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="text-4xl font-bold">{{ trans('messages.title') }}: {{ $announcement->title }}</h1>
                ...
                <div class="card shadow my-4">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th style="width: 150px; text-align: left;">{{ trans('messages.title') }}:</th>
                                <td>{{ $announcement->title }}</td>
                            </tr>
                            <tr>
                                <th style="width: 150px; text-align: left;">{{ trans('messages.image') }}:</th>
                                <td>
                                    <img src="{{ asset('storage/' . $announcement->image) }}" width="300" class="mt-2">
                                </td>
                            </tr>
                            <tr>
